...
def fulfillment_queue(
    ...
    return svc.fulfillment_queue(limit, country, category)
...
def inventory_queue(limit: int = 50, country: str | None = None):
    return svc.inventory_queue(limit, country)
...
def forecast_queue(limit: int = 50, country: str | None = None):
    return svc.forecast_queue(limit, country)
